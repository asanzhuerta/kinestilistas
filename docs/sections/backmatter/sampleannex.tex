...
\section{Listas} 
A continuación vamos a explicar cómo poder añadir una lista, ya sean numeradas o no numeradas. Primero, señalar que las listas enumeradas son las que siguen una secuencia y se crean dentro del entorno \textit{enumerate}. Sin embargo, las no numeradas consisten en \textit{ítems} que a su izquierda tienen un símbolo no numérico y se crean con el entorno \textit{itemize}.
