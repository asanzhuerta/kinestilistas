...
\begin{enumerate}
    ...
    \item \textbf{Comunicaciones internas.} Mostrar promociones, formaciones, avisos y descuentos aplicados a pedido. \textcolor{red}{Conviene explicar que las comunicaciones externas quedan como trabajo futuro}, mientras que el núcleo interno ya es funcional.
\end{enumerate}
