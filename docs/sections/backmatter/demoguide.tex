...
\begin{enumerate}
    ...
    \item \textbf{Auditoría y operación transversal.} Abrir \path{/admin/audit}, \path{/admin/settings}, \path{/admin/integrations}, \path{/admin/support}, \path{/admin/operations} y \path{/admin/enterprise-operations}. Mostrar los resúmenes de M7, el diagnóstico de rate limiting, las exportaciones \texttt{CSV}, el registro de operaciones empresariales y la generación de propuestas a proveedor.
    ...
    \item \textbf{Comunicaciones internas.} Mostrar promociones, formaciones, avisos y descuentos aplicados a pedido. Conviene explicar que las comunicaciones externas quedan como trabajo futuro, mientras que el núcleo interno ya es funcional.
\end{enumerate}
...
\begin{itemize}
    ...
    \item las líneas futuras no corrigen carencias básicas, sino que amplían una base ya funcional hacia automatización, integraciones externas y explotación avanzada de datos.
\end{itemize}
