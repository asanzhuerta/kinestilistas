...
\begin{enumerate}
    ...
    \item \textbf{Auditoría y ajustes.} Abrir \path{/admin/audit} y \path{/admin/settings}. Mostrar la trazabilidad administrativa, la exportación \texttt{CSV}, la configuración visible de canales de avisos y el cargo de agencia. Conviene explicar que el rate limiting, los inventarios técnicos y la base de Factusol/n8n quedan implementados como infraestructura interna, pero no como pantallas de uso diario.
    ...
    \item \textbf{Catálogo y coloración.} Mostrar el catálogo de productos, filtros, ficha de producto, recursos asociados y coloración en vista por filas. Si se enseña un tinte, destacar la relación entre producto pedible y tonalidad cromática.
    \item \textbf{Pedido, preparación de reparto y pagos.} Crear o abrir un pedido, revisar sus líneas con imagen de producto y descuentos visibles, elegir entrega por comercial o agencia, preparar un reparto con bultos manuales, enseñar la etiqueta QR o agencia y registrar un pago parcial desde el detalle.
    \item \textbf{Área de cliente.} Acceder como cliente profesional para mostrar catálogo, pedidos propios, elección de entrega, información de reparto, perfil y badge de rango comercial en la barra lateral. Este punto evidencia que el sistema no es solo administrativo.
    ...
    \item \textbf{Comunicaciones multicanal.} Mostrar promociones, formaciones, avisos, activación de notificaciones del dispositivo y descuentos aplicados a pedido. Conviene explicar que el canal interno ya es la fuente principal y que correo SMTP y Web Push están implementados como canales opcionales, mientras que \textcolor{red}{\textit{WhatsApp} y los envíos planificados en segundo plano quedan como trabajo futuro}.
\end{enumerate}
