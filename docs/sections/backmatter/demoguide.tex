...
\begin{enumerate}
    ...
    \item \textbf{Auditoría y operación transversal.} Abrir \path{/admin/audit}, \path{/admin/settings}, \path{/admin/integrations}, \path{/admin/support} y \path{/admin/operations}. Mostrar los resúmenes de M7, el diagnóstico de rate limiting y las exportaciones \texttt{CSV}.
