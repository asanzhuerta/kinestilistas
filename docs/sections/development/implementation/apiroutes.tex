...
{\apiTableSetup
\begin{longtable}{A{0.10\textwidth}A{0.27\textwidth}A{0.15\textwidth}A{0.38\textwidth}}
\caption{Endpoints de pedidos, repartos y cobros}\\
\apiHeader
\endfirsthead
\apiHeader
\endhead
...
\texttt{GET} & \path{/api/commercial/order-deliveries/:id/qr-pdf} & Comercial & Parámetro \texttt{id}. Respuesta \texttt{200}: PDF de etiqueta de reparto; en agencia muestra marca \texttt{AGENCIA} en lugar de QR.\\
\end{longtable}
}
