...
\begin{itemize}
    ...
    \item configuración global persistida para políticas de rate limiting;
...
Este modelo relacional actúa como fuente de verdad del sistema. Las operaciones criticas de autenticación, gestión comercial, catálogo, pedidos, administración transversal y operación empresarial se apoyan en esta capa.
...
En la base de datos solo se persisten las URLs finales y, cuando procede, metadatos auxiliares como la miniatura asociada a una referencia cromatica. Esto simplifica el modelo, reduce el peso de la base de datos y permite reutilizar un almacenamiento optimizado para contenido multimedia.
...
\begin{itemize}
    ...
    \item la geometría de ruta comercial, que se consulta a \texttt{OSRM} en tiempo de ejecucion \citep{osrmdocs2026};
...
Esta separación evita almacenar resultados efimeros o facilmente regenerables cuando su valor depende de datos del negocio ya presentes en el sistema.
