...
\begin{itemize}
    ...
    \item \textcolor{red}{La integración con servicios externos de mensajería, correo electrónico o \textit{WhatsApp} queda fuera del alcance implementado en esta iteración.}
\end{itemize}
