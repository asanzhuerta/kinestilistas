...
\texttt{RF-M4-01} & Pedidos y reparto & Cliente, comercial & Crear, editar, confirmar, cancelar y consultar pedidos, manteniendo líneas, productos, referencias de color y estados coherentes. \\
\hline
\texttt{RF-M4-02} & Pedidos y reparto & Comercial, cliente & Vincular pedidos confirmados a visitas de reparto, validar entregas mediante QR y sincronizar el estado logístico con la visita. \\
\hline
...
\hline
\texttt{RF-M6-02} & Comunicaciones & Administrador, cliente & Gestionar segmentos o categorías de clientes y aplicar promociones o descuentos según pertenencia a dichos segmentos. \\
\hline
