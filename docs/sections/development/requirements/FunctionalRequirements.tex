...
\begin{itemize}
    ...
    \item En la iteración actual, las promociones se muestran como información comercial dentro de la aplicación, sin aplicar todavía descuentos automáticos sobre el cálculo del pedido.
\end{itemize}
