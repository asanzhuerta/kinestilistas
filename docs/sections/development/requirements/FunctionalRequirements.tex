...
\begin{itemize}
    ...
    \item En el alcance actual, el sistema debe facilitar la copia del borrador o su apertura mediante el cliente de correo configurado en el dispositivo, sin requerir todavía integración directa con un proveedor externo de envío.
\end{itemize}
...
\begin{itemize}
    ...
    \item El cliente debe poder visualizar su rango comercial actual en el panel de cliente y en su perfil, junto con las promociones activas disponibles para su segmento.
    \item La asignación automática en función de criterios comerciales o de uso queda contemplada como evolución futura del módulo.
\end{itemize}
...
\begin{itemize}
    ...
    \item La integración con servicios externos de mensajería, correo electrónico o \textit{WhatsApp} queda fuera del alcance implementado en esta iteración.
\end{itemize}
...
\begin{itemize}
    ...
    \item El sistema debe permitir generar propuestas de pedido a proveedor a partir de productos activos del catálogo, conservando líneas, cantidades, importes y motivo de reposición.
