...
\begin{figure}[H]
      ...
      \fbox{%
            \begin{minipage}[c][0.34\textheight][c]{0.88\linewidth}
                  \centering
                  Espacio reservado para incorporar el modelo conceptual global de datos definitivo.
            \end{minipage}%
      }
      \caption{Modelo conceptual global de datos pendiente de incorporacion}
...
\begin{itemize}
      ...
      \item \textbf{RT-N4 — Canal válido de notificación}
            En la implementación actual el canal persistido es \texttt{in\_app}; otros canales quedan como evolución futura.
