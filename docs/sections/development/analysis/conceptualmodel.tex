...
Para mejorar la legibilidad, el modelo conceptual se presenta por módulos. En cada módulo se recogen las clases del dominio ya existentes en la implementación o, \textcolor{red}{cuando el módulo no esta construido todavía, las clases previstas a nivel analitico}.
...
\begin{figure}[H]
      ...
      \caption{\textcolor{red}{Modelo conceptual global de datos pendiente de incorporacion}}
...
\begin{itemize}
      ...
      \item \textbf{RT-N4 — Canal válido de notificación}
            \textcolor{red}{En la implementación actual el canal persistido es \texttt{in\_app}; otros canales quedan como evolución futura.}
