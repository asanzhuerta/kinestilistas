...
\begin{figure}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{0.17\textwidth}|X|}
        ...
        \hline
        Administrador & \texttt{/admin} $\rightarrow$ usuarios, solicitudes, clientes, auditoría, catálogo, pedidos globales, operación \texttt{M7}, integraciones, soporte técnico y \texttt{/admin/settings}. Desde estos espacios se accede a listados, detalle, formularios de alta y vistas transversales de estado. \\
        \hline
...
Como evidencia visual especifica del modulo \texttt{M6}, se han incorporado tambien capturas del centro administrativo de comunicaciones y de las vistas finales usadas por cliente y comercial. Estas pantallas muestran la publicacion de promociones, el acceso a formaciones, las notificaciones internas, el indicador de avisos pendientes desde los paneles de rol y la conexion operativa entre promociones activas y pedidos con descuento aplicado.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./figures/Capturas/m6-order-promotion-discount.png}
    \caption{Captura real de pedido con descuento promocional aplicado}
    \label{fig:ui-real-m6-order-discount}
\end{figure}
