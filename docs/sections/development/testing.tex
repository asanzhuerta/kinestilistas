...
\begin{itemize}
    ...
    \item \texttt{M4}: borradores de pedido en cliente y comercial, búsqueda de producto en líneas, confirmación y cancelación coherente, bandeja de pedidos pendientes de reparto, visita rutinaria finalizable, visita de entrega con validación QR, paso a \texttt{delivered}, subflujo mínimo de cobro y trazabilidad cruzada desde admin.
